...
__all__ = [
    'SpeechCategoryAudioOut', 'ISpeechObjectTokenCategory',
    'DISPID_SGRSTPropertyId', 'SSTTDictation', 'DISPID_SVSPhonemeId',
    'SPCT_SUB_COMMAND', 'DISPID_SLPType', 'ISpeechCustomStream',
    'eLEXTYPE_PRIVATE13', 'SP_VISEME_6',
    'DISPID_SpeechObjectTokenCategory', 'SVP_16',
    'SpeechVoiceCategoryTTSRate', 'SRADynamic', 'ISpAudio',
    'SpeechVoiceSpeakFlags', 'SPVPRIORITY',
    'DISPID_SPPEngineConfidence', 'SDTAudio', 'SRCS_Enabled',
    'SAFTADPCM_22kHzStereo', 'ISpeechPhraseProperty',
    'DISPID_SASetState', 'DISPID_SRCreateRecoContext',
    'DISPID_SABIBufferSize', 'DISPID_SpeechPhraseElements',
    'DISPID_SRRPhraseInfo', 'ISpRecognizer3', 'ISpProperties',
    'DISPID_SGRSTPropertyName', 'DISPID_SGRId', 'SVP_14',
    'SpeechDictationTopicSpelling', 'DISPID_SOTGetAttribute',
    'SSTTWildcard', 'DISPID_SAFSetWaveFormatEx', 'SITooQuiet',
    'Speech_Max_Word_Length', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRRecognizer', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpeechWordType',
    'ISpeechLexiconPronunciations', 'SpVoice', 'DISPID_SOTsItem',
    'SREAudioLevel', 'SpeechAudioFormatType', 'SPXRO_SML',
    'ISpResourceManager', 'SRESoundEnd', 'SpeechBookmarkOptions',
    'SPBO_TIME_UNITS', 'SAFTExtendedAudioFormat',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT11kHz8BitStereo',
    'SVP_1', 'SpeechRuleAttributes', 'SVP_21',
    'DISPID_SRCCreateGrammar', 'SPRST_NUM_STATES',
    'DISPID_SGRInitialState', 'SECFEmulateResult',
    'SpeechEngineProperties', 'DISPID_SpeechPhraseRules', 'SASPause',
    'SAFT11kHz16BitStereo', '__MIDL_IWinTypes_0009',
    'DISPID_SRCEPhraseStart', 'SVP_3', 'SP_VISEME_19',
    'DISPID_SRDisplayUI', 'eLEXTYPE_PRIVATE10', 'ISpPhrase',
    'SPCATEGORYTYPE', 'SAFTCCITT_ALaw_11kHzStereo', '_SPAUDIOSTATE',
    'SWPUnknownWordUnpronounceable', 'SBONone', 'SPAO_RETAIN_AUDIO',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRState', 'SDTDisplayText',
    'DISPID_SPEs_NewEnum', 'SPINTERFERENCE_NOISE', 'DISPID_SFSClose',
    'SpSharedRecoContext', 'DISPID_SPRuleFirstElement',
    'SPAUDIOSTATE', 'DISPID_SWFEBlockAlign', 'DISPID_SVEBookmark',
    'SAFT12kHz16BitStereo', 'DISPID_SRCRecognizer', 'ISpNotifySink',
    'SLTApp', 'DISPID_SDKOpenKey', 'DISPID_SLPSymbolic',
    'DISPID_SFSOpen', 'SAFT12kHz8BitMono', 'SpeechUserTraining',
    'DISPID_SRCVoice', 'DISPID_SRRTLength', 'SpeechCategoryAudioIn',
    'SPPS_Noncontent', 'SpMMAudioEnum', 'SPSEMANTICERRORINFO',
    'DISPID_SRSetPropertyString', 'STSF_FlagCreate',
    '_ISpeechRecoContextEvents', 'SPEI_RESERVED1', 'DISPID_SPEsItem',
    'SGPronounciation', 'DISPID_SVEventInterests', 'SRAExport',
    'SREBookmark', 'IInternetSecurityMgrSite',
    'SpeechGrammarTagUnlimitedDictation', 'SPPS_Unknown',
    'SPWORDPRONOUNCEABLE', 'ISpeechRecoContext',
    'SAFTADPCM_11kHzMono', 'SpeechVoicePriority',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechAudioStatus', 'SPAS_CLOSED',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechPartOfSpeech',
    'DISPID_SRCERequestUI', 'SBOPause', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPIAudioSizeBytes', 'SRTStandard', 'SPLOADOPTIONS',
    'SpeechStreamSeekPositionType', 'SPEI_MAX_TTS',
    'SPEI_INTERFERENCE', 'ISpeechRecoResult2', 'ISpeechBaseStream',
    'SRERecoOtherContext', 'SAFT16kHz16BitStereo', 'SVSFIsFilename',
    'SpeechCategoryRecognizers', 'SRERequestUI',
    'DISPID_SGRsFindRule', 'SP_VISEME_20', 'SPWORDPRONUNCIATIONLIST',
    'STCLocalServer', 'SAFTCCITT_ALaw_22kHzStereo', 'SRARoot',
    'DISPID_SGRsCount', 'SPEI_SOUND_START',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVSFVoiceMask',
    'SAFT24kHz8BitMono', 'SPEI_REQUEST_UI', 'SRTExtendableParse',
    'SPCS_DISABLED', 'ISpeechDataKey', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechGrammarRuleState', 'DISPID_SLGenerationId',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpAudioFormat', 'SPPS_RESERVED4',
    'SGDSActiveWithAutoPause', 'SP_VISEME_4', 'SPRS_ACTIVE',
    'SVF_None', 'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVSCurrentStreamNumber', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFTNonStandardFormat',
    'DISPID_SLGetWords', 'SVEStartInputStream', 'SASRun',
    'eLEXTYPE_VENDORLEXICON', 'SPSHT_OTHER', 'SPPROPERTYINFO',
    'ISpeechRecoResultDispatch', 'SPSVerb', 'DISPID_SGRsAdd',
    'SVP_18', 'DISPID_SpeechGrammarRuleState', 'SAFT24kHz16BitStereo',
    'SPPARTOFSPEECH', 'SGRSTTWord',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPANumberOfElementsInResult',
    'ISpPhoneticAlphabetConverter', 'SVEViseme',
    'DISPID_SPCIdToPhone', 'DISPID_SDKEnumKeys',
    'SAFT22kHz16BitStereo', 'DISPID_SRGSetWordSequenceData',
    'SPAR_Low', 'SpeechInterference', 'DISPID_SPRulesItem',
    'SPAS_RUN', 'SRAONone', 'SpeechEngineConfidence', 'SVF_Emphasis',
    'DISPID_SPIElements', 'STSF_CommonAppData', 'SVEWordBoundary',
    'ISpRecoContext2', 'SpObjectToken', 'ISpeechAudioFormat',
    'DISPID_SpeechRecoResult', 'DISPID_SPIRule',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'STSF_LocalAppData', 'DISPID_SVSLastResult',
    'SSSPTRelativeToStart', 'DISPID_SpeechPhraseInfo',
    'SPGRAMMARWORDTYPE', 'DISPID_SRRAlternates', 'SRATopLevel',
    'SPRS_INACTIVE', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCCreateResultFromMemory', 'SAFT48kHz8BitStereo',
    'DISPID_SOTCreateInstance', 'SFTInput', 'DISPID_SRRRecoContext',
    'ISpeechPhraseElement', 'ISpMMSysAudio', 'SINoise', 'SVEPrivate',
    'ISpeechGrammarRule', 'SPEVENTSOURCEINFO', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpeechPhraseProperties', 'DISPID_SRRAudio',
    'IInternetSecurityManager', 'SPEI_SR_AUDIO_LEVEL',
    'SPPS_NotOverriden', 'SPRECOSTATE', 'SpeechEmulationCompareFlags',
    'DISPID_SLPsCount', 'SREStreamEnd', 'SPEI_SR_PRIVATE',
    'SREAdaptation', 'SPWORDLIST', 'DISPID_SPRFirstElement',
    'SPRST_ACTIVE', 'SDTRule', 'SVP_12', 'DISPID_SLPLangId',
    'SRSActiveAlways', 'SPEI_UNDEFINED', 'SAFT44kHz16BitStereo',
    'SPPS_RESERVED3', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechPhraseElement', 'SINoSignal',
    'DISPID_SRCEPropertyStringChange', 'SPSNotOverriden',
    'ISequentialStream', 'DISPID_SPPs_NewEnum', 'ISpeechPhraseRules',
    'DISPID_SRRGetXMLErrorInfo', 'SAFTNoAssignedFormat', 'SPWORDTYPE',
    'DISPID_SLGetPronunciations', 'SPGS_EXCLUSIVE',
    'DISPID_SRProfile', 'DISPID_SMSADeviceId',
    'DISPID_SPRuleNumberOfElements', 'SPFM_NUM_MODES', 'SINone',
    'DISPID_SRGCommit', 'DISPID_SRSetPropertyNumber',
    'SpeechAudioProperties', 'DISPID_SOTCSetId',
    'DISPID_SpeechRecognizerStatus', 'SREInterference',
    'SRSEIsSpeaking', 'SPPS_Modifier', 'DISPID_SGRSAddRuleTransition',
    'ISpeechXMLRecoResult', 'DISPID_SVResume', 'DISPID_SVVoice',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE12',
    'SDKLLocalMachine', 'SPCT_SUB_DICTATION', 'SAFT16kHz16BitMono',
    'ISpLexicon', 'SPAR_Unknown', 'DISPID_SPEAudioTimeOffset',
    'SAFTADPCM_22kHzMono', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechVoice', 'DISPID_SPRules_NewEnum',
    'DISPID_SLWsCount', 'SREAllEvents', 'SP_VISEME_14',
    'DISPID_SRRTimes', 'SVSFlagsAsync', 'STCInprocServer',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpPhraseAlt',
    'SPVISEMES', 'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE6',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSERIALIZEDPHRASE',
    'SPEI_TTS_BOOKMARK', 'SDA_One_Trailing_Space', 'SpPhoneConverter',
    'SREPrivate', 'SPPS_RESERVED1', 'ISpeechLexiconWord',
    'SPEI_SR_RETAINEDAUDIO', 'SVEPhoneme', 'SPEI_MIN_SR',
    'SLODynamic', 'SAFT44kHz16BitMono', 'DISPID_SRGId',
    'DISPID_SDKCreateKey', 'SPRS_ACTIVE_USER_DELIMITED', 'SVP_10',
    'SpNullPhoneConverter', 'SpTextSelectionInformation',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SOTDisplayUI',
    'SP_VISEME_10', 'DISPID_SpeechPhraseReplacements', 'IStream',
    'DISPID_SGRSTs_NewEnum', 'SPPS_SuppressWord',
    'SAFT48kHz16BitMono', 'SRSInactiveWithPurge',
    'DISPID_SVGetVoices', 'SpeechMicTraining', 'SVEVoiceChange',
    'Speech_StreamPos_RealTime', 'SPPS_Noun', 'SPVPRI_OVER',
    'SPPS_Function', 'SPAO_NONE', 'DISPID_SPEActualConfidence',
    'DISPID_SASState', 'DISPID_SOTsCount', 'SPSFunction',
    'SpeechPropertyHighConfidenceThreshold',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_5',
    'DISPID_SpeechRecoContextEvents', 'ISpeechVoice', 'STSF_AppData',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SLGetGenerationChange',
    'SVEAllEvents', 'SPAR_High', 'DISPID_SPRuleEngineConfidence',
    'SpPhoneticAlphabetConverter', 'SpeechRunState', 'SPEI_SOUND_END',
    'DISPID_SVEStreamStart', 'SAFT12kHz16BitMono', 'SDTProperty',
    'SVPAlert', 'ISpeechAudioBufferInfo', 'DISPID_SOTs_NewEnum',
    'SP_VISEME_18', 'DISPID_SPAStartElementInResult',
    'SpUnCompressedLexicon', 'DISPID_SOTGetDescription',
    'DISPID_SRGetPropertyNumber', 'SPPHRASERULE',
    'DISPID_SRRSpeakAudio', 'SPVPRI_NORMAL',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPEPronunciation',
    'DISPID_SMSALineId', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVAudioOutput', 'DISPID_SpeechPhraseAlternates',
    'SPEI_MAX_SR', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SDKDeleteKey', 'SPFM_OPEN_READONLY',
    'SAFT16kHz8BitStereo', 'SASStop', 'SSFMOpenReadWrite',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SGSEnabled',
    'DISPID_SVWaitUntilDone', 'SECHighConfidence', 'SRTAutopause',
    'DISPID_SpeechFileStream', 'ISpeechPhraseElements',
    'eLEXTYPE_PRIVATE17', 'SPEI_RESERVED5',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLWType',
    'SRAORetainAudio', 'SP_VISEME_8', 'SpInprocRecognizer',
    'DISPID_SASFreeBufferSpace', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPIStartTime', 'SpeechCategoryAppLexicons', 'SP_VISEME_5',
    'SPPS_RESERVED2', 'ISpeechPhraseAlternate', 'SPSSuppressWord',
    'SpeechAudioState', 'SP_VISEME_16', 'SVP_0', 'DISPID_SVSVisemeId',
    'SpeechPropertyResponseSpeed', 'SWPUnknownWordPronounceable',
    'SAFTCCITT_uLaw_22kHzStereo', 'SGRSTTDictation',
    'DISPID_SpeechRecoResultTimes', 'SPAUDIOBUFFERINFO',
    'SPDKL_LocalMachine', 'SGSDisabled', 'DISPID_SRCState',
    'Speech_Default_Weight', 'DISPID_SVEStreamEnd',
    'DISPID_SPCPhoneToId', 'DISPID_SRSClsidEngine',
    'DISPID_SRRTStreamTime', 'ISpeechRecognizer',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPIRetainedSizeBytes', 'SAFTGSM610_44kHzMono',
    'SAFT24kHz8BitStereo', 'SpeechCategoryRecoProfiles',
    'DISPID_SVGetProfiles', 'DISPID_SRAudioInput', 'SPEI_ADAPTATION',
    'SPDKL_DefaultLocation', 'DISPID_SRCEStartStream',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRGCmdLoadFromObject',
    'ISpeechPhoneConverter', 'SpResourceManager', 'SVP_6',
    'SPGRAMMARSTATE', 'ISpeechRecoResult', 'SpeechStreamFileMode',
    'DISPID_SLAddPronunciation', 'DISPID_SPELexicalForm',
    'SPEI_START_INPUT_STREAM', 'SPSHT_Unknown',
    'DISPID_SpeechPhraseRule', 'DISPID_SMSAMMHandle',
    'SPXMLRESULTOPTIONS', 'SPSNoun', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPIDSPTSI_SelectionLength',
    'SpPhraseInfoBuilder', 'DISPID_SRGetPropertyString',
    'SVEEndInputStream', 'SPEI_RESERVED2', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SASNonBlockingIO',
    'DISPID_SRGRules', 'DISPID_SRCERecognitionForOtherContext',
    'ISpeechResourceLoader', 'SPEI_FALSE_RECOGNITION',
    'ISpRecognizer2', 'DISPID_SRStatus',
    'SSSPTRelativeToCurrentPosition',
    'SpeechGrammarRuleStateTransitionType', 'SPINTERFERENCE',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE4', 'DISPID_SOTCDefault',
    'SpeechAudioFormatGUIDText', 'DISPID_SPRuleParent',
    'SpeechPropertyAdaptationOn', 'ISpeechMMSysAudio',
    'SVEAudioLevel', 'SVP_7', 'DISPID_SPPsCount', 'SSFMCreate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPGS_DISABLED',
    'ISpObjectToken', 'DISPID_SRRTOffsetFromStart',
    'SWPKnownWordPronounceable', 'SPSEMANTICFORMAT', 'SPWT_LEXICAL',
    'SDKLCurrentUser', 'Speech_Max_Pron_Length',
    'DISPID_SVIsUISupported', 'DISPID_SPPName',
    'SDA_No_Trailing_Space', 'DISPID_SVSInputWordPosition',
    'DISPID_SABIEventBias', 'DISPID_SPPsItem', 'SpCompressedLexicon',
    'SDTReplacement', 'DISPID_SpeechRecognizer', 'DISPID_SGRSTRule',
    'SpeechVisemeType', 'SVSFParseSapi', 'DISPID_SRGReset',
    'DISPID_SGRAttributes', 'DISPID_SpeechLexicon',
    'DISPID_SGRSTNextState', 'SECLowConfidence',
    'ISpeechRecoResultTimes', 'DISPID_SGRSAddSpecialTransition',
    'SSSPTRelativeToEnd', 'DISPID_SVPause',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_RESERVED7',
    'DISPID_SGRsDynamic', 'SPEI_END_SR_STREAM', 'SITooLoud',
    'DISPID_SBSFormat', 'DISPID_SOTGetStorageFileName',
    'SpeechTokenIdUserLexicon', 'SAFT8kHz8BitStereo',
    'DISPID_SABufferInfo', 'SpeechTokenValueCLSID', 'SP_VISEME_0',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRCEEnginePrivate',
    'SPSTREAMFORMATTYPE', 'SVP_15', 'SREFalseRecognition',
    'SPEI_WORD_BOUNDARY', 'SpeechRecoProfileProperties', 'SVP_2',
    'DISPID_SRCEEndStream', 'SpMMAudioOut', 'SPRULESTATE',
    'ISpRecognizer', 'DISPID_SpeechAudioFormat', 'SVP_4', 'ISpStream',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPRuleId',
    'SpWaveFormatEx', 'SVPOver', 'SpeechRegistryUserRoot',
    'eLEXTYPE_PRIVATE9', 'SDTPronunciation', 'eLEXTYPE_PRIVATE11',
    'SpeechGrammarWordType', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCSetAdaptationData', 'SGDSInactive',
    'SDA_Consume_Leading_Spaces', 'SPSHORTCUTPAIR', 'ISpShortcut',
    'DISPID_SVEVoiceChange', 'SPEVENTENUM', 'SPAS_STOP',
    'DISPID_SPILanguageId', 'SAFTADPCM_44kHzMono', 'SPEI_RECOGNITION',
    'SVSFIsNotXML', 'DISPID_SRCRequestedUIType',
    'DISPID_SPRulesCount', 'DISPID_SOTRemove', 'SAFT11kHz8BitMono',
    'DISPID_SPEAudioStreamOffset', 'SREStreamStart',
    'SpNotifyTranslator', 'SpSharedRecognizer', 'eLEXTYPE_RESERVED4',
    'DISPID_SPEsCount', 'ISpPhoneConverter', 'SDKLDefaultLocation',
    'DISPIDSPRG', 'SAFT8kHz8BitMono', 'DISPID_SVEPhoneme',
    'DISPID_SpeechGrammarRule', 'Speech_StreamPos_Asap',
    'DISPID_SPIGrammarId', 'DISPID_SRCRetainedAudio',
    'DISPID_SGRName', 'eLEXTYPE_RESERVED8', 'DISPID_SOTSetId',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPRuleName',
    'SpeechTokenKeyAttributes', 'SPPHRASEELEMENT',
    'SPXRO_Alternates_SML', 'DISPID_SpeechAudioStatus', 'SP_VISEME_3',
    'DISPID_SPIAudioSizeTime', 'DISPID_SLWWord', 'SP_VISEME_15',
    'SPCT_SLEEP', 'SLOStatic', 'DISPID_SVSRunningState',
    'eLEXTYPE_RESERVED9', 'DISPID_SRCEventInterests',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechAudio',
    'ISpeechRecognizerStatus', 'SRSEDone', 'ISpNotifySource',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRGSetTextSelection',
    'DISPID_SPARecoResult', 'SRAInterpreter', 'SPAS_PAUSE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SAFTDefault',
    'SVSFNLPSpeakPunc', 'SAFTCCITT_uLaw_11kHzStereo',
    'eLEXTYPE_USER_SHORTCUT', 'SITooFast', 'SpeechGrammarState',
    'SpeechAddRemoveWord', 'DISPID_SPPNumberOfElements',
    'SPRECOCONTEXTSTATUS', 'DISPID_SpeechDataKey', 'SPBO_PAUSE',
    'SPBOOKMARKOPTIONS', 'DISPID_SPERetainedSizeBytes', 'IEnumString',
    'SAFT16kHz8BitMono', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPDKL_CurrentConfig',
    'DISPID_SPEEngineConfidence', 'SAFT48kHz8BitMono',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_PHRASE_START',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPAsItem', 'SPLO_DYNAMIC',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTCGetDataKey',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCEHypothesis',
    'SAFT22kHz8BitStereo', 'SGLexical', 'DISPID_SpeechGrammarRules',
    'SAFT12kHz8BitStereo', 'DISPID_SVEWord', 'DISPID_SAEventHandle',
    'SECFNoSpecialChars', 'SAFT44kHz8BitMono', 'SAFTGSM610_11kHzMono',
    'ISpeechPhraseReplacement', 'DISPID_SAStatus', 'SRCS_Disabled',
    'SGLexicalNoSpecialChars', 'SpLexicon', 'SPEI_MIN_TTS',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechVoiceEvent',
    'SRESoundStart', 'SPWAVEFORMATTYPE', 'SRAImport',
    'DISPID_SAFType', 'DISPID_SAVolume', 'DISPID_SWFEChannels',
    'SGDSActiveUserDelimited', 'ISpeechLexiconPronunciation',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFT44kHz8BitStereo',
    'DISPID_SPIProperties', 'ISpeechPhraseReplacements',
    'SRTSMLTimeout', 'DISPID_SPIGetText', 'SPWORD',
    'DISPID_SDKDeleteValue', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCEBookmark', 'DISPID_SBSSeek', 'DISPID_SWFEFormatTag',
    'SpeechRecognizerState', 'SVF_Stressed', 'SpeechVisemeFeature',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechLexiconWord', 'SAFT11kHz16BitMono',
    'ISpNotifyTranslator', 'DISPID_SAFGuid', 'SSFMOpenForRead',
    'DISPID_SRGIsPronounceable', 'SAFT24kHz16BitMono',
    'SpeechLexiconType', 'DISPID_SPRsItem',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVSFParseMask',
    'ISpGrammarBuilder', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SGRsCommit', 'DISPID_SDKGetBinaryValue', 'SPFILEMODE',
    'SpeechSpecialTransitionType', 'DISPID_SpeechCustomStream',
    'ISpStreamFormatConverter', 'DISPID_SOTCategory',
    'ISpeechObjectTokens', 'SVSFNLPMask',
    'DISPID_SASCurrentSeekPosition', 'SPSUnknown',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPERequiredConfidence',
    'DISPID_SPIEnginePrivateData', 'eLEXTYPE_PRIVATE1',
    'DISPID_SBSWrite', 'tagSPPROPERTYINFO',
    'DISPID_SVSInputSentencePosition', 'SPAR_Medium',
    'DISPID_SRIsUISupported', 'SGRSTTWildcard', 'SPSHT_NotOverriden',
    'SPRULE', 'SPWORDPRONUNCIATION', 'SPSMF_SAPI_PROPERTIES',
    'SPSLMA', 'SpStreamFormatConverter', 'DISPID_SPRNumberOfElements',
    'DISPIDSPTSI', 'SP_VISEME_21', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCResume', 'tagSTATSTG', 'DISPID_SVSLastBookmark',
    'SRTReSent', 'SpeechCategoryVoices', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_11kHzMono', 'SGRSTTEpsilon', 'SpeechRuleState',
    'DISPID_SPIReplacements', 'DISPID_SGRsItem', 'eWORDTYPE_DELETED',
    'SRTEmulated', 'DISPID_SRSSupportedLanguages', 'SPPS_LMA',
    'DISPID_SPIAudioStreamPosition', 'ISpStreamFormat',
    'SVSFParseSsml', 'SPWT_DISPLAY', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SGRSTText', 'DISPID_SLWs_NewEnum',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_PRIVATE3',
    'DISPID_SGRSTsItem', 'DISPID_SOTCId', 'SPGS_ENABLED',
    'DISPID_SPACommit', 'DISPID_SVAudioOutputStream', 'SITooSlow',
    'SVP_8', 'DISPID_SPCLangId', 'ISpeechRecoGrammar',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE8', 'DISPID_SDKEnumValues',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechFileStream',
    'eWORDTYPE_ADDED', 'SAFT32kHz16BitMono', 'DISPID_SVSkip',
    'SPEI_PHONEME', 'SECFIgnoreWidth', 'SVESentenceBoundary',
    'SRSInactive', 'SpeechRecoEvents',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVESentenceBoundary',
    'SAFT48kHz16BitStereo', 'DISPID_SRCEAudioLevel',
    'SPPS_Interjection', 'SPCT_DICTATION', 'SPSHT_EMAIL',
    'SpeechVoiceSkipTypeSentence', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRRSaveToMemory',
    'SVP_17', 'SAFT22kHz16BitMono', 'SP_VISEME_2',
    'DISPID_SRCERecognition', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRs_NewEnum', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRSAudioStatus', 'DISPID_SRCBookmark',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechMMSysAudio',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechAudio',
    'DISPID_SPEDisplayText', 'SRADefaultToActive',
    'SAFTGSM610_8kHzMono', 'SpeechCategoryPhoneConverters',
    'SAFT22kHz8BitMono', 'DISPID_SWFEAvgBytesPerSec', 'SVP_20',
    'SPSHORTCUTTYPE', 'SAFTADPCM_44kHzStereo',
    'DISPID_SWFESamplesPerSec', 'eLEXTYPE_PRIVATE15',
    'SpeechVoiceEvents', 'DISPID_SGRSTransitions',
    'ISpeechPhraseInfoBuilder', 'ISpDataKey', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechPhoneConverter', 'SpObjectTokenCategory',
    'SPSERIALIZEDRESULT', 'DISPID_SVSInputWordLength',
    'DISPID_SRGDictationUnload', 'SPBO_NONE', 'SP_VISEME_1',
    'SpeechRecognitionType', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFT32kHz8BitMono', 'DISPID_SVDisplayUI', 'SpeechAllElements',
    'DISPID_SGRSTWeight', 'DISPID_SRGRecoContext',
    'SAFT32kHz16BitStereo', 'SpeechRetainedAudioOptions',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_RESERVED10', 'DISPID_SPRText', 'SPRECOGNIZERSTATUS',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_VOICE_CHANGE',
    'DISPID_SLWsItem', 'DISPID_SRRDiscardResultInfo',
    'SpInProcRecoContext', 'SREHypothesis', 'SpeechDiscardType',
    'SPBO_AHEAD', 'DISPID_SMSGetData',
    'DISPID_SASCurrentDevicePosition', 'SpShortcut',
    'ISpeechGrammarRules', 'DISPID_SRCEPropertyNumberChange',
    'SVSFIsXML', 'SP_VISEME_11', 'DISPID_SpeechRecoResult2',
    'DISPID_SRAudioInputStream', 'DISPID_SABIMinNotification',
    'DISPID_SpeechObjectToken', 'eLEXTYPE_PRIVATE14',
    'ISpeechLexicon', 'DISPID_SRGDictationLoad', 'ISpEventSource',
    'STCInprocHandler', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPAPhraseInfo', 'SpeechRecoContextState',
    'SpMemoryStream', 'SPCS_ENABLED',
    'DISPID_SRSCurrentStreamPosition', 'SPTEXTSELECTIONINFO',
    'SVEBookmark', 'SpeechGrammarTagDictation', 'SLTUser',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechFormatType',
    'SPVOICESTATUS', 'SPRECORESULTTIMES', 'DISPID_SDKSetLongValue',
    'DISPID_SRCEAdaptation', 'DISPID_SADefaultFormat',
    'DISPID_SPAsCount', 'IEnumSpObjectTokens', 'ISpRecoCategory',
    'SpeechTokenShellFolder', 'SVP_11', 'DISPID_SPEAudioSizeTime',
    'SPCONTEXTSTATE', 'DISPID_SVRate', 'SVP_19', 'SP_VISEME_12',
    'DISPID_SPEAudioSizeBytes', 'SPADAPTATIONRELEVANCE',
    'SPDKL_CurrentUser', 'ISpeechTextSelectionInformation',
    'DISPID_SDKGetStringValue', 'SP_VISEME_13',
    'DISPID_SDKGetlongValue', 'DISPID_SRCESoundStart', 'SWTAdded',
    'SVSFPersistXML', 'SPEI_VISEME',
    'ISpeechGrammarRuleStateTransitions', 'SAFT8kHz16BitMono',
    'DISPID_SVGetAudioInputs', 'SpCustomStream',
    'SREPropertyNumChange', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SPIGetDisplayAttributes', 'SPEI_RESERVED6',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCCmdMaxAlternates', 'SPSInterjection',
    'ISpXMLRecoResult', 'ISpeechPhraseInfo', 'SPWF_INPUT',
    'SGRSTTRule', 'DISPID_SVPriority', 'DISPID_SGRSTType',
    'DISPID_SLAddPronunciationByPhoneIds', 'SGDSActive',
    '_RemotableHandle', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPISaveToMemory',
    'ISpEventSink', 'DISPID_SpeechPhraseProperty',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPDATAKEYLOCATION',
    'SSTTTextBuffer', 'SPEI_SR_BOOKMARK',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechPhraseBuilder',
    'STCRemoteServer', 'DISPID_SREmulateRecognition',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRCERecognizerStateChange',
    'SDA_Two_Trailing_Spaces', 'DISPID_SABufferNotifySize',
    'SGRSTTTextBuffer', 'DISPID_SRGetFormat', 'SWTDeleted',
    'DISPID_SOTMatchesAttributes', 'SVP_13', 'SREStateChange',
    'SpeechTokenKeyUI', 'DISPID_SPPValue', 'SPLEXICONTYPE',
    'DISPID_SVVolume', 'SPEVENT', 'SASClosed', 'ISpRecoContext',
    'DISPID_SOTId', 'DISPID_SVEAudioLevel', 'SpStream',
    'DISPID_SVSpeak', 'SECFIgnoreCase', 'LONG_PTR', 'SPSModifier',
    'SPFM_OPEN_READWRITE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechPhraseRule', 'SECNormalConfidence', 'DISPID_SPPId',
    'SPWF_SRENGINE', 'SAFT8kHz16BitStereo', 'DISPID_SRRTTickCount',
    'SpeechPropertyComplexResponseSpeed', 'SpeechDisplayAttributes',
    'SPRST_INACTIVE', 'ISpObjectTokenCategory', 'SpFileStream',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPRs_NewEnum', 'DISPID_SLPsItem', 'ISpeechObjectToken',
    'SPEI_TTS_PRIVATE', 'SDTAlternates', 'UINT_PTR',
    'DISPID_SVEViseme', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechDataKeyLocation',
    'DISPID_SGRAddResource', 'SPEI_RECO_OTHER_CONTEXT',
    'SPPHRASEPROPERTY', 'ISpRecoGrammar2', 'DISPID_SVSpeakStream',
    'DISPID_SPRuleConfidence', 'SAFTADPCM_11kHzStereo',
    'SGSExclusive', 'SPFM_CREATE', 'ISpRecoResult',
    'DISPID_SWFEExtraData', 'ISpeechGrammarRuleStateTransition',
    'SVPNormal', 'DISPID_SVEEnginePrivate', 'SVSFDefault',
    'SSFMCreateForWrite', 'SAFTGSM610_22kHzMono',
    'DISPID_SDKSetBinaryValue', 'SREPhraseStart',
    'ISpObjectWithToken', 'DISPID_SpeechXMLRecoResult',
    'SAFT32kHz8BitStereo', 'SPEI_HYPOTHESIS', 'SRERecognition',
    'DISPID_SPPConfidence', 'DISPID_SOTDataKey', 'DISPID_SGRSRule',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRGetRecognizers',
    'DISPID_SPPParent', 'DISPID_SPRuleChildren', 'DISPID_SPRsCount',
    'SpeechTokenKeyFiles', 'SP_VISEME_17', 'DISPID_SRRAudioFormat',
    'WAVEFORMATEX', 'SpeechGrammarTagWildcard',
    'SPINTERFERENCE_TOOSLOW', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPFirstElement', 'SpeechLoadOption',
    'SREPropertyStringChange', 'SVSFUnusedFlags',
    'DISPID_SCSBaseStream', 'DISPID_SRIsShared', 'DISPID_SLWLangId',
    'DISPID_SRGDictationSetState', 'SP_VISEME_9',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRRGetXMLResult',
    'DISPID_SpeechLexiconWords', 'DISPID_SGRAddState',
    'ISpeechLexiconWords', 'DISPID_SVStatus', 'ISpVoice',
    'SpeechTokenContext', 'SAFTText', 'DISPID_SPIEngineId',
    'DISPID_SGRClear', 'ISpeechPhraseAlternates',
    'SAFTADPCM_8kHzMono', 'SECFIgnoreKanaType',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SDKSetStringValue', 'SDTLexicalForm',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPERetainedStreamOffset',
    'SPSMF_UPS', 'SPEI_RESERVED3', 'SRSActive',
    'DISPID_SLRemovePronunciation', 'SPWT_PRONUNCIATION',
    'SECFDefault', 'DISPID_SRCEFalseRecognition',
    'DISPID_SLWPronunciations', 'ISpeechMemoryStream',
    'SPPHRASEREPLACEMENT', 'SpeechWordPronounceable',
    'DISPID_SRCPause', 'eLEXTYPE_PRIVATE16', 'SPEI_RECO_STATE_CHANGE',
    'SpMMAudioIn', 'DISPID_SWFEBitsPerSample', 'STCAll',
    'SP_VISEME_7', 'SPBINARYGRAMMAR', 'eLEXTYPE_APP',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRSTsCount',
    'DISPID_SpeechBaseStream', 'DISPID_SRCEInterference',
    'DISPID_SRGState', 'SpeechAudioVolume', 'DISPID_SMSSetData',
    'SDTAll', 'DISPID_SRSCurrentStreamNumber',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechObjectTokens',
    'SPLO_STATIC', 'SPPHRASE', 'ISpSerializeState', 'SPAUDIOOPTIONS',
    'DISPID_SLPPhoneIds', 'DISPID_SBSRead', 'DISPID_SOTIsUISupported',
    'DISPID_SpeechMemoryStream', 'SGDisplay',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPPChildren',
    'SPINTERFERENCE_TOOQUIET', 'ISpRecoGrammar', 'SPAUDIOSTATUS',
    'SFTSREngine', 'SPINTERFERENCE_NONE', 'ISpeechVoiceStatus',
    'SPVPRI_ALERT', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechWaveFormatEx', 'SPPS_Verb', 'SVP_9',
    '_ISpeechVoiceEvents', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SLPs_NewEnum', 'SVSFParseAutodetect'
]
